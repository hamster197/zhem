        ...
        var option = {
            // Add title
                ...
                legend: {
                    orient: 'vertical',
                    x: 'left',
                    data: ['1-комнатные', 'Opera', 'Safari', 'Firefox', 'Chrome']
                },
                ...
                series: [{
                    ...
                    center: ['50%', '57.5%'],
                    data: [
                        {value: {{ tonecount }}, name: '1-комнатные'},
                        {value: 310, name: '2-комнатные'},
                        {value: 234, name: '3-комнатные'},
                        {value: 135, name: 'Студии'},
                        {value: 1548, name: 'Дома'}
