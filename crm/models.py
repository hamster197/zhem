...
class zayavka(models.Model):
    ...
    kanal_choises = (('Заявка с сайта','Заявка с сайта'),('Заявка с сайта новостройка','Заявка с сайта новостройка'),
                     ('Заявка с Вестум','Заявка с Вестум'),('Заявка с Avito', 'Заявка с Avito'),
                     ('Тел. звонок','Тел. звонок'),('Домклик','Домклик'),('Личный','Личный'))
    ...
    komn_choises = (('Студия','Студия'),('Однокомнатная','Однокомнатная'),('Двухкомнатная','Двухкомнатная'),
                    ...
                    ('Многокомнатная','Многокомнатная'),('Неважно','Неважно'),('Дом','Дом'),('Участок','Участок'),
                    ('Коммерция','Коммерция'))
    ...
    pricina_otkaza = models.CharField(max_length=45, choices=prichina_otkaza_choises ,
                                      verbose_name='Причина отказа клиента',default='')
