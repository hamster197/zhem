...
def flat_postForm(request):
    n1='Квартиры'
    n2='подача на Cайт, RegionalRealty, ДомКлик, Юла, Yandex, Mail, Realtymag.ru, EBN.ru'
    n3 = zayavka.objects.filter(status='Свободен').count()
    if request.POST:
...
######################################################################################################################
        ...
        AvitoTurbo = AvitoTurbo +(otchet_nov.objects.filter(date_sozd__gte=ds, date_sozd__lte=de, sdelka_zakrita='Да-Рассрочка',
                                              ot_kuda_kl='Avito Turbo').count())
...
def stat_count_crm_obj_past(request):
    ...
    for i in user:
        if i.is_active:
            ...
            cian_count = flat_obj.objects.filter(author_id=i.id, date_sozd__gte=d11, date_sozd__lte=d1).count()
            zv = zayavka.objects.filter(reelt_auth_id = i.id).count()
            zv_w = zayavka.objects.filter(reelt_auth_id = i.id, date_sozd__gte=d11, date_sozd__lte=d1).count()
            s = stat_obj_crm(auth_nic  = i.username, auth_ful_name = i.first_name +' '+i.last_name, auth_group = i.groups.get().name,
                             crm_calc_week= countss_w ,crm_calc_kadastr=countss_kadastr ,crm_calc = countss, cian_calc=cian_count,
...
#################################################
                        ...
                        if rasr_sum2:
                            ...
                            if rasr_sum2.get('vneseno_komisii2__sum'):
                                r_sum = str(int(r_sum) + int(rasr_sum2.get('vneseno_komisii2__sum')  / rielt_count))
                            else:
                                r_sum = r_sum
                        ...
                        if rasr_sum3:
                            ...
                            if rasr_sum3.get('vneseno_komisii3__sum'):
                                r_sum = str(int(r_sum) + int(rasr_sum1.get('vneseno_komisii3__sum') / rielt_count))
                            else:
                                r_sum = r_sum
                        ...
                        if rasr_sum4:
                            ...
                            if rasr_sum4.get('vneseno_komisii4__sum'):
                                r_sum = str(int(r_sum) + int(rasr_sum1.get('vneseno_komisii4__sum') / rielt_count))
                            else:
                                r_sum = r_sum
                        ...
                        if rasr_sum5:
                            ...
                            if rasr_sum5.get('vneseno_komisii5__sum'):
                                r_sum = str(int(r_sum) + int(rasr_sum1.get('vneseno_komisii5__sum')  / rielt_count))
                            else:
                                r_sum = r_sum
